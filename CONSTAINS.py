...
DONT_FOUND_MATCH_TEXT = """We are still looking for your next co-workers. In the meantime, don’t wait to be creative! 
...
HAVE_NOT_ACCOUNT_TEXT = "You do not have an account."
